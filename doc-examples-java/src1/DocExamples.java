...
===========================*/
	...
	try
	{
		FileInputStream fis = new FileInputStream("foobar3");  
		BufferedInputStream bis = new BufferedInputStream(fis);
	...
	try
	{
		FileInputStream fis = new FileInputStream("foobar4");  
		BufferedInputStream bis = new BufferedInputStream(fis);
	...
	public void ResourceLeak5()
    {
	try
	{
		FileInputStream fis = new FileInputStream("foobar5");  
		BufferedInputStream bis = new BufferedInputStream(fis);
	...
	public void ResourceLeak6()
    {
	try
	{
		FileInputStream fis = new FileInputStream("foobar6");  
		BufferedInputStream bis = new BufferedInputStream(fis);
	...
	public void ResourceLeak7()
    {
	try
	{
		FileInputStream fis = new FileInputStream("foobar7");  
		BufferedInputStream bis = new BufferedInputStream(fis);
